...
// I have scala 2.12.10 in my machine, but this file has scala 2.13 features (e.g. Using)
// I refactored some code for scala 2.12, but I left new features commented
...
object ByKeyFunctions {
   ...
   */
  val words: Seq[String] = Source.fromFile("/opt/spark-data/words.txt").getLines().toSeq
...
//  }
  ...
  val wordCounts =
    sc.parallelize(Seq.fill(2000000)(words(random.nextInt(words.length)), random.nextInt(1000)))
